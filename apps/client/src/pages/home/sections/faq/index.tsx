...
// Who are you, and why did you build Bot About Me?
const Question1 = () => (
  <AccordionItem value="1">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      ...
      <p>
        ...
        to build the first version of Bot About Me in 2019. Since then, it's gone through multiple
        iterations as I've learned a lot of better coding practices over the years.
      </p>

      <p>
        At the time of writing, Bot About Me is probably one of the only handful of resume builders
      ...
      <p>
        ...
        basis, and I'm extremely proud to say that Bot About Me, over it's years of development, has{" "}
...
// How much does it cost to run Bot About Me?
const Question2 = () => (
  <AccordionItem value="2">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      <p>
        ...
        has graciously sponsored their infrastructure to allow me to host Bot About Me on their
  ...
  <AccordionItem value="3">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      ...
      <p>
        ...
        that's wishful thinking. But if you do mention Bot About Me on your blog, let me know so
...
// What languages are supported on Bot About Me?
const Question4 = () => {
  ...
  return (
    <AccordionItem value="4">
      ...
      <AccordionContent className="prose max-w-none dark:prose-invert">
        <p>
          Here are the languages currently supported by Bot About Me, along with their respective
  ...
  <AccordionItem value="5">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      <p>
        ...
        me in my everyday work and with the development of Bot About Me. It only makes sense that
      ...
      <p>
        ...
        adding a key in the Settings page and still make use of all the useful features that Bot
        About Me has to offer. I would even suggest you to take the extra step of using ChatGPT to
        write your content, and simply copy it over to Bot About Me.
      </p>
    </AccordionContent>
  </AccordionItem>
);
    ...
    <div className="grid gap-12 lg:grid-cols-3">
      <div className="space-y-6">
        ...
        <p className="text-base leading-loose">
          Here are some questions I often get asked about Bot About Me.
        </p>
