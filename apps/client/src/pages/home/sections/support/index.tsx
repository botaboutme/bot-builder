...
export const SupportSection = () => (
  ...
  >
    <div className="container space-y-6">
      <h1 className="text-4xl font-bold">{t`Supporting Bot About Me`}</h1>

      <p className="max-w-4xl leading-loose">{t`Bot About Me `}</p>
      ...
      <p className="max-w-4xl leading-loose">
        {t`Even if you're not in a position to contribute financially, you can still make a difference by giving the GitHub repository a star, spreading the word to your friends, or dropping a quick message to let me know how Bot About Me has helped you. Your feedback and support are always welcome and much appreciated!`}
      </p>
    </div>
  </section>
);
